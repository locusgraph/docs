...
export const DOCS: Record<Product, Record<string, () => Promise<DocModule>>> = {
  ...
  spendgraph: {
    ...
    "sdk/api": () => import("@spendgraph/sdk/docs/api.mdx"),
    "sdk/budgets": () => import("@spendgraph/sdk/docs/budgets.mdx"),
    "sdk/integrations": () => import("@spendgraph/sdk/docs/integrations.mdx"),
    "sdk/quickstart": () => import("@spendgraph/sdk/docs/quickstart.mdx"),
